...
export PKG_REPO_BRANCH_BACKPORT=${PKG_REPO_BRANCH_BACKPORT:-"v2_7_2"}
export PKG_REPO_BRANCH_DEVEL=${PKG_REPO_BRANCH_DEVEL:-"v2_9_1"}
...
export FREEBSD_BRANCH=${FREEBSD_BRANCH:-"${REPO_BRANCH_PREFIX}RELENG_2_9_0"}
...
if [ -z "${MODULES_OVERRIDE}" ]; then
	...
	export MODULES_OVERRIDE_amd64="${MODULES_OVERRIDE_base}  amdsmn amdtemp  coretemp cpuctl cxgbe/tom  if_wg aesni blake2 ipmi ix ixv   nmdm qlnx sfxge vmm"
...
export POUDRIERE_PORTS_GIT_BRANCH=${POUDRIERE_PORTS_GIT_BRANCH:-"${REPO_BRANCH_PREFIX}RELENG_2_9_0"}
